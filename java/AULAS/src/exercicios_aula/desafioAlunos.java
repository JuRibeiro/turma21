...
public class desafioAlunos 
{
	...
	public static void main(String[] args)
	{
		...
		String grupoG6 []= {"Dafhne Novais", "Juliana Ribeiro", "José Luis", "Tainah Vinha"};
		int matricula []= new int [4];
		
		for (int x=0; x<4; x++)
		{
			System.out.println("Informe a matricula de: "+grupoG6[x]);
			matricula[x] = leia.nextInt();
		...
		for (int x=0; x<4; x++)
		{
			for (int i=0; i<4; i++)
			{
				System.out.printf("Nome: ", grupoG6[i], "Matricula: ", matricula[x]);
			}
		} */
